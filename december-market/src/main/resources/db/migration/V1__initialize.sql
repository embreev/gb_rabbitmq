...
create table orders (id bigserial, user_id bigint, price numeric(8, 2) not null, address varchar (255) not null, phone_number varchar(30) not null, status varchar(50), primary key(id), constraint fk_user_id foreign key (user_id) references users (id));
